...
class Config:
    ...
    MAIL_SERVER = 'smtp.ox.ac.uk'
    MAIL_PORT = 25
    MAIL_USE_TLS = True
    MAIL_USERNAME = os.environ.get('MAIL_USERNAME')
    MAIL_PASSWORD = os.environ.get('MAIL_PASSWORD')
    AAAS_MAIL_SUBJECT_PREFIX = '[OUCE AAaS]'
    AAAS_MAIL_SENDER = 'OUCE IT Support <itsupport@ouce.ox.ac.uk>'
    AAAS_ADMIN = os.environ.get('AAAS_ADMIN')
